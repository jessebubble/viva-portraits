...
export default function Nav() {
    ...
    return (
        ...
        <nav className='bg-slate-900 border-b'>
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0 p-3 md:p-5">
                <Link to='/' className=''>
                ...
                <div className="hidden md:block">
                    <div className='space-x-2 md:space-x-3 lg:space-x-4 text-lg md:text-xl text-white pr-2 tracking-tighter antialiased'>
                        <Link to='/pricing' 
