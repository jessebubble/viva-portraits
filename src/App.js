      ...
      <div className='container flex flex-wrap justify-between items-center mx-auto'>
        ...
        <div className='hidden w-full md:block md:w-auto' id='navbar-default'>
          <ul className='flex flex-col p-4 pt-4 bg-gray-900 rounded-lg border border-gray-700 
            ...
            <Link to='/' 
                  className='block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:p-0 hover:text-rose-400'
    ...
    <footer className='bg-gray-900 border-gray-200 px-2 sm:px-4 py-2.5'>
      <div className='sm:flex sm:items-center sm:justify-between'>
        ...
        <ul className='flex flex-wrap items-center justify-center pb-6 xl:pb-7 xl:pt-1 text-xl xl:text-2xl text-gray-500 sm:pb-0'>
          <Link to='/' className='pr-4 md:pr-6 hover:underline hover:text-rose-400'>Home</Link>
          <Link to='/portraits' className='pr-4 md:pr-6 hover:underline hover:text-rose-400'>Portraits</Link>
          <Link to='/pricing' className='pr-4 md:pr-6 hover:underline hover:text-rose-400'>Pricing</Link>
          <Link to='/contact' className='pr-4 md:pr-6 hover:underline hover:text-rose-400'>Contact</Link>
        </ul>
      </div>
